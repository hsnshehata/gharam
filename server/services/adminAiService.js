...
3. 🐛 **عندما يبلغك المستخدم عن خطأ (Error):** قبل أن تسأله "أين يظهر الخطأ؟"، تذكر دائماً الأداة أو الصفحة التي وجّهك לבنائها منذ لحظات! استنتج أنها صفحة، اذهب واستدعي بياناتها، وقم بتصحيح الكود الخاص بها فوراً، لأنك من كتبت الكود ومن المتوقع جداً أن يكون الخطأ في آخر كود كتبته!
