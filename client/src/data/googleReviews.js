...
export const googleReviews = [
  ...
  },
  {
    author: 'AYA OMRAN'',
    relativeTime: 'قبل سنة',
    text: 'ماشاء الله عليكي احلي بيوتي سنتر  💚💚  '
  },
  {
    author: 'yasmin Omar',
    relativeTime: 'قبل سنة',
    text: 'احلي واشيك مكان تسلم ايدك مدام غرام '
  },
  {
    author: 'هدي العبد',
    relativeTime: 'قبل سنة',
    text: '😍أجمل بيوتي سنتر قى دسوق كلها والمعامله قمر 🥰  '
  },
  {
    author: 'Aml Yaseen',
    relativeTime: 'قبل سنة',
  ...
  },
  {
    author: 'Ahmad Ahmad',
    relativeTime: 'قبل سنة',
    text: '❤️اجمل بيوتي سنتر فى دسوق كلها بجد والمعامله قمر ❤️ '
  },
  {
    author: 'Tota Basim',
    relativeTime: 'قبل سنة',
    text: 'بجد الميكب تحفه جدآ جدآ مشفتش عروسه مش حميله عندها والتعامل كمان حلو وشيك جدا 😍  '
  },
  {
    author: 'شهد السقا',
    relativeTime: 'قبل سنة',
    text: 'احسن معامله واحسن ميكب ارتست ف دسوق انتي توب التوب ي مدام غرام ❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️ '
  },
  {
    author: 'shahd elsaka',
    relativeTime: 'قبل سنة',
    text: 'احسن ميكب ارتست بجد توب التوب ♥️♥️♥️♥️♥️♥️♥️♥️♥️ '
  },
  {
    author: 'Walaa El. Bohy',
    relativeTime: 'قبل سنة',
    text: '♥️اجمد بيوتى سنتر فى دسوق كلها والمعامله تحفهه ♥️ '
  },
  {
    author: 'Koky ali',
    relativeTime: 'قبل سنة',
    text: '♥️غرام سلطان أجمد بيوتي سنتر حرفيا فى دسوق كلها ♥️ '
  },
  {
    author: 'Nada Shenak',
    relativeTime: 'قبل سنة',
  ...
  },
  {
    author: 'amar arfaa',
    relativeTime: 'قبل سنة',
    text: 'غرام سلطان اجمل بيوتي سنتر فى دسوق كلها كنت طالعه عروسه قمر '
  },
  {
    author: 'منار نبيل',
    relativeTime: 'قبل سنة',
    text: '❤❤ اجمل واحلي بيوتي سنتر واشطر ميكب ارتست ربنا يوفقها يارب '
  },
  {
    author: 'Medo Omre',
    relativeTime: 'قبل سنة',
    text: '❤️أجمل بيوتي سنتر فى دسوق كلها حرفيا والمعامله ذوق ❤️ '
  },
  {
    author: 'نرمين عوض',
    relativeTime: 'قبل سنة',
    text: 'غرام سلطان أشطر ميكب أرتست ف دسوق ممتازه جدا وعندها ضميرفي شغلها بجد 🥰🥰🥰  '
  },
  {
    author: 'حبيبة الرحمن',
    relativeTime: 'قبل سنة',
    text: 'احلي و اجمل غرام و حقيقي مكان جميل و ذوقك ما شاء الله عليكي ربنا يكرمك ب كل خير و يوفقك ف شغلك ي حبيبتي ♥️♥️  1 '
  },
  {
    author: 'Mahmoud Ali',
    relativeTime: 'قبل سنة',
    text: 'انا ام ايمي  حضرتك زوقك جدا ومحترمه جدا جدا برضو وزوقك عالي اوى وكل العرايس اللي نتزليها جميله جدا جدا وكل الالوان مناسبه كل واحده ربنا يرزقك ويصلح حالك ويقويكي وكمان المكان جميل جداً والناس اللي شغالها زوقك وحضرتك كمان دايما في نجاح وتفوق  1 '
  },
  {
    author: 'Najlaa Gomaa',
    relativeTime: 'قبل سنة',
    text: 'انا كنت بقول مش هعمل ميكب فى دسوق لحد ما شوفت صبيتى عاملة عندك اى الجمال ده اى الرقة دى طلعتها قمر بجد تسلم ايدك ومن دلوقت بقولك جيالك ❤❤  2 '
  },
  {
    author: 'Nada Mahros',
    relativeTime: 'قبل سنة',
    text: 'مكان تحفه وناس هاديه ومحترمه🩵   1 '
  },
  {
    author: 'اشرقت زيان',
    relativeTime: 'قبل سنة',
    text: 'بجد من احسن البيوتي سنتر في دسوق وانشا الله فرح وحنه عندو ومن جمالو العيله كلها عامل عندها 🥰🥰🥰😁   1 '
  },
  {
    author: 'Esraa Mohamed',
    relativeTime: 'قبل سنة',
    text: 'اجمل واحسن حد بيعمل ميكب و عندهم اروع الفساتين  1 '
  },
  {
    author: 'Heba Mohamed',
    relativeTime: 'قبل سنة',
    text: 'أجمل بيوتى سنتر فى دسوق بجد ♥️  1 '
  },
  {
    author: 'اسماء احمد',
    relativeTime: 'قبل سنة',
    text: 'احلي واجمل ميكب واحسن تصوير  واحسن معمله من طقم العمل كله  ♥❤احسن ميكب بجد  1 '
  },
  {
    author: 'Merna Amer',
    relativeTime: 'قبل سنة',
    text: 'احلي مكان بجد كفايه المعامله الذوق والشغل النضيف غرام سلطان نمبر وان ❤️❤️❤️❤️  1 '
  },
  {
    author: 'هانى محمد',
    relativeTime: 'قبل سنة',
  ...
  {
    author: 'Noura Mahmoud',
    relativeTime: 'قبل سنة',
    text: 'نا مجربتش حاجه عندك بصراحه بس مرات اخويا كانت عندك و بجد كانت قمر اووي والله ماشاء الله وان شاءالله خطوبتي بعد العيد ونتي معايا ف خطوبه وحنه وفرح إنشاءالله عشان من زمان اووي والله كان نفسي اجي اعمل عندك تنضيف بشرة بس الظروف بقا وبجد بحبك اوويي غرام ونفسي تكسبيني عندك🥰🤎🤎🤎.   1 '
  },
  {
    author: 'زوجي وكفي',
    relativeTime: 'قبل سنة',
    text: 'ماشاء الله تسلم ايدك ياحبيبتي 💙   1 '
  },
  {
    author: 'Madleen Darwesh',
    relativeTime: 'قبل سنة',
    text: 'اشطر غرام ف الدنيا وارق ميك اب ارتست  1 '
  },
  {
    author: 'Mariam Soltan',
    relativeTime: 'قبل سنة',
    text: 'احلى بيوتي سنتر بجد 💜   1 '
  },
  {
    author: 'Mai hkayre',
    relativeTime: 'قبل سنتين',
    text: 'اجمل كوافير ف مدينه دسوق❤️⭐ '
  },
  {
    author: 'Eman Zezo',
    relativeTime: 'قبل سنتين',
    text: 'أجمل ميك اب ارتست في دسوق  1 '
  },
  {
    author: 'Fatma Abdelwahab',
    relativeTime: 'قبل سنتين',
    text: 'احلي سنتر في الدنيا'
  }
];
