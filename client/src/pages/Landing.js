...
function Landing() {
	...
	const css = `
		...
		.landing-page { margin: 0; padding: 0; background: #080f0b; color: #f5f0e8; font-family: 'Tajawal', 'Arial', sans-serif; min-height: 100vh; position: relative; overflow: hidden; }
		.landing-page, .landing-page * { box-sizing: border-box; }
		.App:has(.landing-page) { padding: 0 !important; margin: 0 !important; }
		...
		.hero { position: relative; width: 100%; height: 100vh; min-height: 600px; display: flex; align-items: center; justify-content: flex-end; overflow: hidden; margin: 0; border-radius: 0; }
