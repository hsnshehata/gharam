    ...
    <ToastProvider>
      <div className="App">
        {authLoading ? (
          ...
          <>
            {user && !isPublicPage && !location.pathname.startsWith('/v2') && <Navbar user={user} setUser={setUser} />}
            {user && !isPublicPage && !location.pathname.startsWith('/v2') && <GlobalAdminWidget />}
            <Routes>
              ...
              <Route
                path="/v2/*"
                element={user ? <V2App user={user} setUser={setUser} /> : <Navigate to="/login" />}
              />
